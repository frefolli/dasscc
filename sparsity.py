...
if __name__ == "__main__":
  ...
  cli.add_argument('-f', '--mindensity', type=int, default=0.01, help='Minimum Matrix density')
  cli.add_argument('-t','--maxdensity', type=int, default=0.4, help='Maximum Matrix density')
  cli.add_argument('-s','--stepdensity', type=int, default=0.05, help='Step of Matrix densitys')
