...
dasscc::Result<Eigen::SparseVector<double_t>> dasscc::ForwardSubstitutionSolver::run(Eigen::SparseMatrix<double_t, Eigen::RowMajor> &A, Eigen::SparseVector<double_t> &b) {
